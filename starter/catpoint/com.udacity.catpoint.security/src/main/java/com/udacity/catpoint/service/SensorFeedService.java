...
public class SensorFeedService
{
	...
	private void getFeedSource() {
		feedSource = "camera/feed" + securityService.getRndFeed() + ".mp4";
	}
	
	public void setFeedFrameBuffer(SynchronousQueue<Mat> ffb) {
	...
	public boolean feedEnabled() { return feed; }
	public boolean showEnabled() { return show; }
